...
namespace NirvanaCommon
{
    public sealed class Xor8
    {
        ...
        public Xor8(byte[] fingerprints, ulong seed)
        {
        ...
        public byte[] Data => _fingerprints;
        ...
        public static Xor8 Construction(ulong[] keys)
        {
            ...
            byte[] fingerprints = Assign(sigma, capacity, blockLength);
            return new Xor8(fingerprints, seed);
        }
        ...
        private static byte[] Assign(Stack<(ulong, int)> sigma, int capacity, int blockLength)
        {
            var fingerprints = new byte[capacity];
