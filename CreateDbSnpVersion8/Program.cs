    ...
    internal static class Program
    {
        private static void Main(string [] args)
        {
            ...
            using (var writer = new AlleleFrequencyWriter(saStream, GRCh37.Assembly, GnomAD.DataSourceVersion,
                GnomAD.JsonKey, GRCh37.NumRefSeqs))
            {
                ...
                writer.StartCommon();
                CompressPipeline.RunPipeline(commonTsvPath, commonBlockSize, writer).Wait();
                writer.EndCommon();
                ...
                writer.StartRare();
                CompressPipeline.RunPipeline(rareTsvPath, rareBlockSize, writer).Wait();
                writer.EndRare();
