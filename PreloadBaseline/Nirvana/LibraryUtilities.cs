    ...
    public static class LibraryUtilities
    {
        public static void CheckLibrary()
        {
            ...
            try
            {
                ...
                if (observedLibraryId != expectedLibraryId)
                    throw new InvalidDataException(
                        "Received an incorrect library ID when validating the Block Compression library.");
            }
            catch (Exception)
            {
                throw new Exception("BlockCompression");
            }
        }
